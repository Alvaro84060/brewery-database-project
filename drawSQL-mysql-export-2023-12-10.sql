CREATE TABLE `products`(
    `product_id` INT UNSIGNED NULL AUTO_INCREMENT,
...
CREATE TABLE `payments`(
    `payment_id` INT UNSIGNED NULL AUTO_INCREMENT,
...
CREATE TABLE `employee_roles`(
    `role_id` INT UNSIGNED NULL AUTO_INCREMENT,
...
CREATE TABLE `order_details`(
    `order_detail_id` INT UNSIGNED NULL AUTO_INCREMENT,
    `order_id` INT NOT NULL,
...
CREATE TABLE `customers`(
    `customer_id` INT UNSIGNED NULL AUTO_INCREMENT,
...
CREATE TABLE `employees`(
    `emp_id` INT UNSIGNED NULL AUTO_INCREMENT,
    `first_name` VARCHAR(255) NULL,
    `last_name` VARCHAR(255) NULL,
...
CREATE TABLE `payment_methods`(
    `method_id` INT UNSIGNED NULL AUTO_INCREMENT,
